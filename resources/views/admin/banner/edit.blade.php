                        ...
                        <div class="add-listing-section">
                            ...
                            <div class="row with-forms">
                                <div class="col-md-6">
                                    ...
                                    <input name="title1" class="search-field" type="text" placeholder="type here..." value="{{$banner->title1}}" />
                                </div>
                                <div class="col-md-6">
                                    <label>Status </label>
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="cta" class="search-field" type="text" placeholder="type here..." value="{{$banner->cta}}"/>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="cta_link" type="text" value="{{$banner->cta_link}}">
                                </div>
                            ...
                            <div class="row with-forms">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="title2" class="search-field" type="text" placeholder="type here..." value="{{$banner->title2}}"/>
                                </div>
